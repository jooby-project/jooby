...
public class DefaultDataBuffer implements DataBuffer {
  ...
  /**
   * Directly exposes the native {@code ByteBuffer} that this buffer is based on. The {@linkplain
   * ByteBuffer#position() position} of the returned {@code ByteBuffer} is set to the {@linkplain
   * #readPosition() read position}, and the {@linkplain ByteBuffer#limit()} to the {@linkplain
  ...
  public DataBuffer.ByteBufferIterator readableByteBuffers() {
    ByteBuffer readOnly =
        this.byteBuffer.slice(this.readPosition, readableByteCount()).asReadOnlyBuffer();
  ...
  public boolean equals(Object other) {
    return (this == other
        || (other instanceof DefaultDataBuffer that
