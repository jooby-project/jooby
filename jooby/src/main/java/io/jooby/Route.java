...
public class Route {
   ...
   * @return This route.
   */
  public Route addTag(String tag) {
    if (this.tags == EMPTY_LIST) {
      this.tags = new ArrayList<>();
    }
    this.tags.add(tag);
  ...
  public static class Set implements Iterable<Route> {
     ...
     * @return This route.
     */
    public Set setRoutes(List<Route> routes) {
      this.routes = routes;
      return this;
    }
     ...
     * @return This route.
     */
    public Set produces(MediaType... produces) {
      return setProduces(Arrays.asList(produces));
    }
     ...
     * @return This route.
     */
    public Set setProduces(Collection<MediaType> produces) {
      routes.forEach(
          it -> {
     ...
     * @return This route.
     */
    public Set consumes(MediaType... consumes) {
      return setConsumes(Arrays.asList(consumes));
    }
     ...
     * @return This route.
     */
    public Set setConsumes(Collection<MediaType> consumes) {
      routes.forEach(
          it -> {
     ...
     * @return This route.
     */
    public Set setAttributes(Map<String, Object> attributes) {
     ...
     * @return This route.
     */
    public Set setAttribute(String name, Object value) {
     ...
     * @return This route.
     */
    public Set setTags(List<String> tags) {
      this.tags = tags;
