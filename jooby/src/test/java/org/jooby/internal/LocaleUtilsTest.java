...
public class LocaleUtilsTest {
  ...
  public void langCountryVariant() {
    assertEquals("ja", LocaleUtils.toLocale("ja_JP_JPr", "_").getLanguage().toLowerCase());
    assertEquals("jp", LocaleUtils.toLocale("ja_JP_JPr", "_").getCountry().toLowerCase());
    assertEquals("jpr", LocaleUtils.toLocale("ja_JP_JPr", "_").getVariant().toLowerCase());
  }
}
