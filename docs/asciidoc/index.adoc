...
Jooby is a modular micro framework. At his core:
  
- Reflection and annotation free
- Only HTTP Routing
- https://github.com/lightbend/config[Configuration] and https://www.slf4j.org[SLF4J]
...
This is not strictly necessary (of course), you may create a `Jooby` application without subclass:
