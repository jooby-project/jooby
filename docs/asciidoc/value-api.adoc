...
- <<context-parameters-query, Query>> encoded as https://tools.ietf.org/html/rfc3986#section-2[RFC 3986]
- <<context-parameters-formdata, Formdata>> encoded as `application/x-www-form-urlencoded`
- <<context-parameters-multipart, Multipart>> encoded as `multipart/form-data`
