...
Structure data is supported using the Value API and the javadoc:WebSocket[render, java.lang.Object] method:
...
Structure messages depends/requires a javadoc:MessageDecoder[] and javadoc:MessageEncoder[]. In this
