...
This modules scan the application `class-path` and automatically discover and register ```MVC routes/controllers```, [Jooby.Module]({{defdocs}}/Jooby.Module.html) and [Jooby.Module]({{defdocs}}/Jooby.html) applications.
