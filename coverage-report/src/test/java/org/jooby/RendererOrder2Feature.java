...
public class RendererOrder2Feature extends ServerFeature {
...

  {
    ...
    renderer(new Renderer() {
      ...
      @Override
      public void render(final Object object, final Context ctx) throws Exception {
        assertEquals("[r2, r1, r3, byte[], ByteBuffer, File, CharBuffer, InputStream, Reader, toString()]",
            ctx.toString());
      }
  ...
  public void order() throws Exception {
    request()
        .get("/renderer/order")
        .expect("[r2, r1, r3, byte[], ByteBuffer, File, CharBuffer, InputStream, Reader, toString()]");
  }
}
