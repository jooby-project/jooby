...
public class AuthorizerFilterTest {
  ...
  private MockUnit.Block profile = unit -> {
    ...
    Request req = unit.get(Request.class);
    expect(req.require(UserProfile.class)).andReturn(profile);
  };
  ...
  private MockUnit.Block pass = unit -> {
    ...
    expect(checker.isAuthorized(unit.get(WebContext.class), unit.get(UserProfile.class), "admin",
  ...
  public void pass() throws Exception {
    new MockUnit(Request.class, Response.class, Config.class, WebContext.class, UserProfile.class,
