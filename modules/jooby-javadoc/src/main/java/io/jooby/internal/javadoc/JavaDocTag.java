...
import static io.jooby.internal.javadoc.JavaDocNode.getText;
import static io.jooby.internal.javadoc.JavaDocStream.*;
import static io.jooby.internal.javadoc.JavaDocStream.children;
...
public class JavaDocTag {
  ...
  public static Map<StatusCode, ApiResponse> throwList(DetailNode node) {
    var result = new LinkedHashMap<StatusCode, ApiResponse>();
    javaDocTag(
        node,
        THROWS,
        (tag, text) -> {
