...
public class AuthFilter implements Route.Filter {
    ...
    private DefaultSecurityLogic<Object, AuthContext> securityLogic = new DefaultSecurityLogic<>();
    ...
    public AuthFilter(final String clients) {
        this(clients, null, null);
    }

    public AuthFilter(final String clients, final String authorizers) {
        this(clients, authorizers, null);
    }

    public AuthFilter(final String clients, final String authorizers, final Boolean multiProfile) {
    ...
    public void handle(final Request req, final Response rsp, final Route.Chain chain) throws Throwable {
        ...
        securityLogic.perform(ctx, config, (parameters, context) -> {
            ...
            chain.next(req, rsp);
            return null;
        }, new JoobyHttpActionAdapter(), clients, authorizers, null, multiProfile);
    }
}
