 ...
 */
package io.jooby.annotation.trpc;
 ...
 *
 * <ul>
 *   <li><b>Explicit tRPC Annotations:</b> Use {@link Query} for read-only operations (mapped to
 *       HTTP GET) and {@link Mutation} for state-changing operations (mapped to HTTP POST).
