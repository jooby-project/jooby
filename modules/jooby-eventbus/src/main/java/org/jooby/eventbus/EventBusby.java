 ...
 * <h1>EventBus</h1>
 * <p>
 *   <a href="http://greenrobot.org/eventbus">EventBus</a> is an open-source library for Java using
 *   the publisher/subscriber pattern for loose coupling. EventBus enables central communication to
 *   decoupled classes with just a few lines of code – simplifying the code, removing dependencies,
 *   and speeding up app development.
 * </p>
 *
 * <h2>usage</h2>
 *
 ...
 *
 * <p>
 *   Here the <code>MySubscriber</code> class will be provisioned by Guice.
 * </p>
 *
 * <h2>custom EventBus</h2>
 * <p>
 *   Jooby uses the default EventBus: <code>EventBus.getDefault()</code>, you can provide a custom
...
public class EventBusby implements Jooby.Module {
  ...
  private final List<Object> initialSubscribers = new ArrayList<>();
  ...
  /**
   * Register an event subscriber. Subscriber will be provisioned by Guice.
   *
   * @param subscriber Event subscriber.
   * @return This module.
   */
