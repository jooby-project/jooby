...
/**
 * This interface should be implemented by modules that provide bean validation functionality. An
 * instance of this interface must be registered in the Jooby service registry. Doing so will enable
 * bean validation for MVC routes. For an example implementation, refer to the
