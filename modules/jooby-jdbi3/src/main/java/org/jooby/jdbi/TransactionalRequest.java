...
public class TransactionalRequest {
   ...
   *
   * @return HTTP method to intercept, defauts is: `*`.
   */
   ...
   * @return This object.
   */
  public TransactionalRequest method(final String method) {
    this.method = method;
    return this;
  }
   ...
   *
   * @return HTTP pattern to interncept, defaults is: `*`.
   */
   ...
   *
   * @param pattern HTTP pattern to intercept.
   * @return This object.
   */
  public TransactionalRequest pattern(final String pattern) {
   ...
   *
   * @return Key for accessing to the request scoped Handle.
   */
   ...
   *
   * @return List of SqlObjects attached to the request scoped Handle.
   */
   ...
   *
   * @param sqlObject SqlObject (a.k.a DAO, Repository) to attach to the request scoped Handle.
   * @return This object.
   */
  public TransactionalRequest attach(final Class sqlObject) {
