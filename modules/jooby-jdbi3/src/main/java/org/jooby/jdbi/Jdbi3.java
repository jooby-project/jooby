 ...
 * <h1>jdbi</h1>
 * <p>
 *   <a href="https://jdbi.github.io">Jdbi</a> provides a convenience interface for SQL operations
 * in Java.
 * </p>
 *
 * <p>This module depends on {@link org.jooby.jdbc.Jdbc} module.</p>
 *
 * <h2>usage</h2>
 *
 * <pre>{@code
 ...
 *
 * <p>
 *   The {#transactionPerRequest()} opens a Handle then start, commit/rollback a transaction and
 *   finally close a Handle.
 * </p>
 *
 * <p>
...
public class Jdbi3 implements Jooby.Module {
  ...
  /**
   * Creates a new Jdbi module and connects to default database key: <code>db</code>.
   */
  public Jdbi3() {
    this("db");
  }
   ...
   * Add a transaction-per-request filter to the route pipeline.
   *
   * @param request Transactional request options.
   * @return This module.
   */
  ...
  @Override public void configure(Env env, Config conf, Binder binder) throws Throwable {
    ...
    trx.forEach(it -> {
      ...
      /** Bind handle: */
      binder.bind(key)
          .toProvider(Providers.outOfScope(key))
