...
public class RouteParameter {
  ...
  public enum Kind {
    ...
    QUERY {
      @Override public <T> T accept(final RouteParameter parameter, final Visitor<T> visitor) {
    ...
    public abstract <T> T accept(RouteParameter parameter, Visitor<T> visitor);
  }
  ...
  public String toString() {
    ...
    buff.append("@").append(kind.name().toLowerCase()).append(" ");
    buff.append(name);
    buff.append(": ").append(type.getTypeName());
    if (value != null) {
