...
public class MvcRoute {
  ...
  public List<String> generateMcpDefinitionMethod(boolean kt) {
    ...
    if (isMcpTool()) {
      String toolName = extractAnnotationValue(this, "io.jooby.annotation.McpTool", "name");
      if (toolName.isEmpty()) toolName = getMethodName();
      String description =
          extractAnnotationValue(this, "io.jooby.annotation.McpTool", "description");
      ...
      for (MvcParameter param : getParameters(false)) {
        ...
        if (kt) {
          buffer.add(
              statement(
                  indent(6),
                  "props.set<com.fasterxml.jackson.databind.JsonNode>(",
                  string(mcpName),
      ...
      // Filter out primitives, java.lang classes (String, Integer, etc.), and MCP classes
        ...
        if (kt) {
          buffer.add(
              statement(
                  ...
                  returnTypeStr,
                  "::class.java)"));
          // Clean and simple Map class conversion!
          buffer.add(
              statement(
                  indent(6),
                  "val ",
      ...
      String promptName = extractAnnotationValue(this, "io.jooby.annotation.McpPrompt", "name");
      if (promptName.isEmpty()) promptName = getMethodName();
      String description =
          extractAnnotationValue(this, "io.jooby.annotation.McpPrompt", "description");
      ...
      String uri = extractAnnotationValue(this, "io.jooby.annotation.McpResource", "value");
      String name = extractAnnotationValue(this, "io.jooby.annotation.McpResource", "name");
      if (name.isEmpty()) name = getMethodName();
      String description =
          extractAnnotationValue(this, "io.jooby.annotation.McpResource", "description");

      boolean isTemplate = uri != null && uri.contains("{") && uri.contains("}");
  ...
  public List<String> generateMcpHandlerMethod(boolean kt) {
    ...
    if (isMcpTool() || isMcpPrompt()) {
      ...
      String uriTemplate = extractAnnotationValue(this, "io.jooby.annotation.McpResource", "value");
