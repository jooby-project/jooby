...
public class HandlerCompilerTest {
            ...
            app -> {
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/cookieParam",
                          MockContextHelper.mockContext().setCookieMap(mapOf("c", "cookie")))
                      .value());
            });
  }
            ...
            app -> {
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/flashParam",
                          MockContextHelper.mockContext().setFlashAttribute("message", "hey"))
                      .value());
            });
  }
    ...
    new MvcModuleCompilerRunner(new Provisioning())
        .module(
            app -> {
              ...
              assertEquals(
                  "[bar]",
                  router.get("/p/listBeanPathParam/bar", MockContextHelper.mockContext()).value());

              assertEquals(
                  "v1", router.get("/p/pathParam/v1", MockContextHelper.mockContext()).value());

              assertEquals(
                  "2", router.get("/p/bytePathParam/2", MockContextHelper.mockContext()).value());

              assertEquals(
                  "3", router.get("/p/longPathParam/3", MockContextHelper.mockContext()).value());

              assertEquals(
                  "3.5",
                  router.get("/p/floatPathParam/3.5", MockContextHelper.mockContext()).value());

              assertEquals(
                  "3.55",
                  router.get("/p/doublePathParam/3.55", MockContextHelper.mockContext()).value());

              assertEquals(
                  "true",
                  router.get("/p/booleanPathParam/true", MockContextHelper.mockContext()).value());

              assertEquals(
                  "1", router.get("/p/intPathParam/1", MockContextHelper.mockContext()).value());

              assertEquals(
                  "Optional[x]",
                  router
                      .get("/p/optionalStringPathParam/x", MockContextHelper.mockContext())
                      .value());

              assertEquals(
                  "Optional[7]",
                  router.get("/p/optionalIntPathParam/7", MockContextHelper.mockContext()).value());

              assertEquals(
                  "bar",
                  router.get("/p/javaBeanPathParam/bar", MockContextHelper.mockContext()).value());

              assertEquals(
                  "[bar]",
                  router
                      .get("/p/listStringPathParam/bar", MockContextHelper.mockContext())
                      .value());

              assertEquals(
                  "[6.7]",
                  router
                      .get("/p/listDoublePathParam/6.7", MockContextHelper.mockContext())
                      .value());

              assertEquals(
                  "[bar]",
                  router.get("/p/setStringPathParam/bar", MockContextHelper.mockContext()).value());

              assertEquals(
                  "[6.7]",
                  router.get("/p/setDoublePathParam/6.7", MockContextHelper.mockContext()).value());

              assertEquals(
                  "[bar]",
                  router.get("/p/setBeanPathParam/bar", MockContextHelper.mockContext()).value());

              assertEquals(
                  "A", router.get("/p/enumParam/a", MockContextHelper.mockContext()).value());

              assertEquals(
                  "Optional[A]",
                  router.get("/p/optionalEnumParam/a", MockContextHelper.mockContext()).value());

              assertEquals(
                  "[B]", router.get("/p/listEnumParam/b", MockContextHelper.mockContext()).value());

              assertEquals(
                  "9",
                  router.get("/p/primitiveWrapper/9", MockContextHelper.mockContext()).value());
            });
  }
    ...
    new MvcModuleCompilerRunner(new Provisioning())
        .module(
            app -> {
              ...
              assertEquals(
                  "123GET /p/parameters/1231x",
                  router
                      .get(
                          "/p/parameters/123",
                          MockContextHelper.mockContext().setQueryString("?offset=1&foo=x"))
                      .value());
            });
  }
        ...
        .module(
            app -> {
              ...
              assertEquals(
                  file.toString(),
                  router
                      .get("/p/fileParam", MockContextHelper.mockContext().setFile("file", file))
                      .value());

              assertEquals(
                  Arrays.asList(file).toString(),
                  router
                      .get("/p/fileParams", MockContextHelper.mockContext().setFile("file", file))
                      .value());
            });
  }
        ...
        .module(
            app -> {
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/uuidParam",
                          MockContextHelper.mockContext()
                              .setQueryString("?value=" + uuid.toString()))
                      .value());
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/bigDecimalParam",
                          MockContextHelper.mockContext()
                              .setQueryString("?value=" + bigDecimal.toString()))
                      .value());
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/bigIntegerParam",
                          MockContextHelper.mockContext()
                              .setQueryString("?value=" + bigInteger.toString()))
                      .value());
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/charsetParam",
                          MockContextHelper.mockContext()
                              .setQueryString("?value=" + charset.toString()))
                      .value());
              ...
              assertEquals(
                  ...
                  router
                      .get(
                          "/p/pathFormParam", MockContextHelper.mockContext().setFile("file", file))
                      .value());
            });
  }
    ...
    new MvcModuleCompilerRunner(new Provisioning())
        .module(
            app -> {
              ...
              MockContext ctx = MockContextHelper.mockContext();
              assertEquals(StatusCode.NO_CONTENT, router.get("/p/returnStatusCode", ctx).value());
    ...
    new MvcModuleCompilerRunner(new Provisioning())
        ...
        .module(
            app -> {
              ...
              assertEquals(
                  ...
                  router
                      .post(
                          "/p/bodyInputStreamParam", MockContextHelper.mockContext().setBody(body))
                      .value());
            })
        .module(
            app -> {
              ...
              assertEquals(
                  channel.toString(),
                  router
                      .post("/p/bodyChannelParam", MockContextHelper.mockContext().setBody(body))
                      .value());
            })
        .module(
            app -> {
        ...
        .module(
            app -> {
              ...
              Type parameterized =
                  Reified.getParameterized(CustomGenericType.class, String.class).getType();
        ...
        .module(
            app -> {
              ...
              assertEquals(
                  "v1",
                  router
                      .get("/jaxrs/query", MockContextHelper.mockContext().setQueryString("?q1=v1"))
                      .value());

              assertEquals("doGet", router.get("/jaxrs", MockContextHelper.mockContext()).value());
    ...
    new MvcModuleCompilerRunner(new NoPathRoute())
        .module(
            app -> {
              ...
              assertEquals("root", router.get("/", MockContextHelper.mockContext()).value());

              assertEquals(
                  "subpath", router.get("/subpath", MockContextHelper.mockContext()).value());
            });
  }

  @Test
  public void nullRoutes() throws Exception {
    new MvcModuleCompilerRunner(new NullRoutes())
        .module(
            app -> {
              MockRouter router = new MockRouter(app);
              ...
              assertEquals("null", router.get("/nullok", MockContextHelper.mockContext()).value());
  ...
  public void routeParam() throws Exception {
    new MvcModuleCompilerRunner(new RouteInjection())
        .module(
            app -> {
              MockRouter router = new MockRouter(app);

              assertTrue(
                  router.get("/route", MockContextHelper.mockContext()).value() instanceof Route);
            });
  }

  @Test
  public void contextPath() throws Exception {
    new MvcModuleCompilerRunner(new RouteContextPath())
        .module(
            app -> {
              MockRouter router = new MockRouter(app);
