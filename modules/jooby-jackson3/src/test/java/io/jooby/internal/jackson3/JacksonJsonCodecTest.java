...
class JacksonJsonCodecTest {
  ...
  @Test
  void shouldDecodeClassSuccessfully() {
    // Arrange
  ...
  @Test
  void shouldDecodeTypeSuccessfully() {
    // Arrange
    String json = "[\"value\"]";
  ...
  @Test
  void shouldPropagateExceptionWhenDecodingTypeFails() {
    // Arrange
    String json = "invalid json";
    Type type = List.class;
  ...
  @Test
  void shouldPropagateExceptionWhenEncodingFails() {
    // Arrange
    Object value = new Object();
    RuntimeException expectedException = mock(RuntimeException.class);
