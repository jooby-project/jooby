...
public interface Request {
  ...
  <T> Optional<T> param(String name, Class<T> paramType);

  <T> T param(String name, Function<String[], T> parser);
  ...
  List<Upload> files() throws Exception;

  Upload file(String name) throws Exception;
  ...
  <T> T bytes(Raw strategy) throws IOException;

  <T> T text(Text strategy) throws IOException;
